...
. Assign the `cloudkms.cryptoKeyEncrypterDecrypter` role to the Cloud KMS key and Cloud Volumes ONTAP service account:
...
+
For information about this predefined role for Google Cloud KMS, refer to the https://cloud.google.com/kms/docs/reference/permissions-and-roles#cloudkms.cryptoKeyEncrypterDecrypter[Google documentation^].
