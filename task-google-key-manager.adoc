...
** Beginning with Cloud Volumes ONTAP 9.13.0, you should assign the https://cloud.google.com/kms/docs/reference/permissions-and-roles#cloudkms.cryptoKeyEncrypterDecrypter[`cloudkms.cryptoKeyEncrypterDecrypter`^] role to the Cloud KMS key and Cloud Volumes ONTAP service account:
...
** For earlier versions of Cloud Volumes ONTAP, you need to create a custom role for your Cloud Volumes ONTAP service account.
