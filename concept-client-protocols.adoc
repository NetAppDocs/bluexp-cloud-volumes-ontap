...
summary: Cloud Volumes ONTAP supports the following client protocols: NFS, SMB, iSCSI, and S3.
---
...
[.lead]
Cloud Volumes ONTAP supports the following client protocols: NFS, SMB, iSCSI, and S3.
