...
Cloud Volumes ONTAP supports S3 as an option for scale-out storage in Microsoft Azure. S3 protocol support enables you to configure S3 client access to objects contained in a bucket in an SVM.
