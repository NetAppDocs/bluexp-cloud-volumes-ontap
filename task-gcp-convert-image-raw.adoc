...
= Convert image to raw format in Google Cloud
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
NOTE: For more information on how to export an image through Google Cloud, refer to https://cloud.google.com/compute/docs/images/export-image#console[Google Cloud doc on Exporting an image^].  