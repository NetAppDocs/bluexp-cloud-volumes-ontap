...
| Tags | Tags that you add to a volume are associated with the link:task-using-tags.html[Application Templates service], which can help you organize and simplify the management of your resources.
