...
.Azure Application Registration [[azure-app]]
...
.Create an Azure Active Directory Endpoint (HA only) [[AAD]]
//pick up here

.Cloud Volumes ONTAP configuration [[ontap]]
