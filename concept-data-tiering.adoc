...
NOTE: Any existing inactive data will maintain the default storage class when you change the storage class. For existing inactive data, you must manually designate the desired storage class.     
+
