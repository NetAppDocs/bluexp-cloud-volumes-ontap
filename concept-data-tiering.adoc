...
+
You can select a storage class when you create the working environment and you can change it any time afterwards. For instructions on changing the storage class, refer to link:task-tiering.html[Tiering inactive data to low-cost object storage].
+
...
+
You can select a storage tier when you create the working environment and you can change it any time afterwards. For details about changing the storage tier, refer to link:task-tiering.html[Tiering inactive data to low-cost object storage].
+
...
+
You can select a storage tier when you create the working environment and you can change it any time afterwards. For details about changing the storage class, refer to link:task-tiering.html[Tiering inactive data to low-cost object storage].
+
The storage class for data tiering is system wide--it's not per volume.
endif::gcp[]
