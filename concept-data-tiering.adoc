...
When Cloud Manager creates an S3 bucket in AWS, it uses the following default settings:
...
Object storage settings::
Cloud Manager creates a new storage account with the following settings:
...
Object storage settings::
When Cloud Manager creates a bucket in Google Cloud, it uses the following default settings:
