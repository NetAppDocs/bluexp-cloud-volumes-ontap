...
If you can't change the instance type from c4, m4, or r4 instances, see KB article link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Converting_an_AWS_Xen_CVO_instance_to_Nitro_(KVM)["Converting an AWS Xen CVO instance to Nitro (KVM)"^].
