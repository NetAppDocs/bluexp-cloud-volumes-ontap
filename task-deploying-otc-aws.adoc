...
** You should have a https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html[Connector that is associated with your workspace^].
...
. If you're prompted, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html[create a Connector^].
...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html[Learn how to add additional AWS credentials to BlueXP^].
...
+
* https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html[Learn more about Cloud Data Sense^]
* https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-to-s3.html[Learn more about BlueXP backup and recovery (Cloud Backup)^]
+
TIP: If you would like to utilize WORM and data tiering, you must disable BlueXP backup and recovery (Cloud Backup) and deploy a Cloud Volumes ONTAP working environment with version 9.8 or above. 
