...
** You should have a link:task-creating-connectors-aws.html[Connector that is associated with your workspace].
...
. If you're prompted, link:task-creating-connectors-aws.html[create a Connector].
...
* link:concept-monitoring.html[Learn more about Monitoring].
...
+
* link:concept-cloud-compliance.html[Learn more about Cloud Data Sense].
* link:task-backup-to-s3.html[Learn more about Cloud Backup].
* link:concept-monitoring.html[Learn more about Monitoring].
