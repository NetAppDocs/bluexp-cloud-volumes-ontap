...
+
Some AWS Local Zones are available. Local Zones must be enabled before you can create and manage resources in those zones. link:https://aws.amazon.com/tutorials/deploying-low-latency-applications-with-aws-local-zones/[Learn how to enable a Local Zone^].
