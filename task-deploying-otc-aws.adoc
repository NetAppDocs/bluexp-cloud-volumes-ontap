...
** You should have a https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html[Connector that is associated with your workspace^].
...
. If you're prompted, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html[create a Connector^].
...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html[Learn how to add additional AWS credentials to Cloud Manager^].
