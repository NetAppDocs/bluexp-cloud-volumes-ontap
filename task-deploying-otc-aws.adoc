...
+
* https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html[Learn more about Cloud Data Sense^]
* https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html[Learn more about Cloud Backup^]
+
TIP: If you would like to utilize WORM and data tiering, you must disable Cloud Backup and deploy a Cloud Volumes ONTAP working environment with version 9.8 or above. 
...
+
* https://docs.netapp.com/us-en/bluexp-classification/concept-cloud-compliance.html[Learn more about Cloud Data Sense^]
* https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-to-s3.html[Learn more about Cloud Backup^]
+
TIP: If you would like to utilize WORM and data tiering, you must disable Cloud Backup and deploy a Cloud Volumes ONTAP working environment with version 9.8 or above. 
