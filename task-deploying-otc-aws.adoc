...
** You should have a https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-aws.html[Connector that is associated with your workspace^].
...
. If you're prompted, https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-aws.html[create a Connector^].
...
https://docs.netapp.com/us-en/cloud-manager-get-started/task-adding-aws-accounts.html[Learn how to add additional AWS credentials to Cloud Manager^].
...
* https://docs.netapp.com/us-en/cloud-manager-monitoring/concept-monitoring.html[Learn more about Monitoring^].

. *Location & Connectivity*: Enter the network information that you recorded in the link:task-planning-your-config.html#aws-network-information-worksheet[AWS worksheet].
+
...
* link:task-deploying-otc-aws.html#licensing[Learn what's required in the wizard for the licensing method that you want to use.]
...
+
image:screenshot_cvo_licensing_aws.gif[A screenshot of the Licensing page]
+
...
+
For help choosing a disk type and size, see link:task-planning-your-config.html#sizing-your-system-in-aws[Sizing your system in AWS].
...
+
For more information, see link:task-planning-your-config.html#choosing-a-volume-usage-profile[Understanding volume usage profiles] and link:concept-data-tiering.html[Data tiering overview].
...
+
* https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html[Learn more about Cloud Data Sense^].
* https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-to-s3.html[Learn more about Cloud Backup^].
* https://docs.netapp.com/us-en/cloud-manager-monitoring/concept-monitoring.html[Learn more about Monitoring^].
...
+
The IP addresses must be outside of the CIDR block for all VPCs in the region. For additional details, see link:reference-networking-aws.html#aws-networking-requirements-for-cloud-volumes-ontap-ha-in-multiple-azs[AWS networking requirements for Cloud Volumes ONTAP HA in multiple AZs].
