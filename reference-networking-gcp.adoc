...
Cloud Manager automatically allocates the required number of private IP addresses to Cloud Volumes ONTAP in GCP. You need to make sure that your networking has enough private IP addresses available.  
...
* *Single node*
Cloud Manager allocates 4 IP addresses to a single node system:
...
* *HA pair*
Cloud Manager allocates 12-13 IP addresses to an HA pair:
+
