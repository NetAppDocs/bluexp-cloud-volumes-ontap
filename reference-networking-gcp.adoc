...
summary: Set up your Google Cloud networking so Cloud Volumes ONTAP systems can operate properly. This includes networking for the Connector and Cloud Volumes ONTAP.
---
...
[.lead]
Set up your Google Cloud networking so Cloud Volumes ONTAP systems can operate properly. This includes networking for the Connector and Cloud Volumes ONTAP.
...
BlueXP allocates the following number of private IP addresses to Cloud Volumes ONTAP in Google Cloud:
