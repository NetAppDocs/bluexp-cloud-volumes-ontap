...
* Another set of rules for HA components in VPC-1, VPC-2, and VPC-3. These rules are open for inbound & outbound communication between the HA components. link: <<Rules-for-VPC-1-VPC-2-and-VPC-3,Learn more>>.
