...
| Used by Cloud Volumes ONTAP to talk to the GCP cloud provider. 

| Google Cloud provider call

| Management for Google Cloud provider functionalities in OCCM will be unavailable. 
