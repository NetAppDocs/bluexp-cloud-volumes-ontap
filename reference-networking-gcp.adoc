...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html[Review the required shared VPC permissions covered in Connector deployment^]
