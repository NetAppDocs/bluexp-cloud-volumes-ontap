...
| Used to retrieve the client secret key from the Azure Key Vault to communicate with S3 bucket for metadata handling.
...
|Cloud Volumes ONTAP resources and the user are not authorized.  
