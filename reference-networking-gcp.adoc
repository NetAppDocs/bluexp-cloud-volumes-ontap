...
+
link:task-verify-autosupport.html[Learn how to verify AutoSupport].
+
...
* *Selected VPC only*: the source filter for inbound traffic is the VPC subnet range. This is the recommended option.
