...
+
If you plan to use BlueXP backup and recovery (Cloud Backup) with your Cloud Volumes ONTAP systems, the IAM role for the nodes must include the second policy shown below.
+
[role="tabbed-block"]
====
.Standard regions
