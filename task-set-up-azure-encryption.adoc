...
If you create a new version of your key, Cloud Volumes ONTAP automatically detects and uses the latest version of the key for encryption, ensuring your data remains secure without the need for manual updates. 
