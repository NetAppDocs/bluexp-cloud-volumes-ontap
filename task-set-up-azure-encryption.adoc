...
[NOTE]
After configuring, ensure that you have https://learn.microsoft.com/en-us/azure/virtual-machines/disk-encryption#customer-managed-keys[enabled key rotation in the Azure portal^], so that Cloud Volumes ONTAP can utilize them. 
