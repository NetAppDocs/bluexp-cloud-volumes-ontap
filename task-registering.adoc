...
+
image:screenshot_features_support_registration.png[Screen shot: Shows the Support registration option under the Features panel for a Cloud Volumes ONTAP system.]
