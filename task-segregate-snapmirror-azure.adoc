...
* The source and destination clusters should have access to the same Virtual Network (VNet). 
...
To move an existing SnapMirror replication relationship, you must first break the existing SnapMirror replication relationship before following the procedure to create a new SnapMirror replication relationship.
