...
keywords: azure private link, private link connection, private link to storage, service endpoints
summary: By default, Cloud Manager enables an Azure Private Link for connections between Cloud Volumes ONTAP virtual machines and other Azure resources. If needed, you can disable Azure Private Links and use service endpoints instead.
---
...
[.lead]
By default, Cloud Manager enables an Azure Private Link for connections between Cloud Volumes ONTAP virtual machines and other Azure resources. If needed, you can disable Azure Private Links and use service endpoints instead.

== Overview

By default, Cloud Manager enables an Azure Private Link for connections between Cloud Volumes ONTAP nodes and other Azure resources:
...
A Private Link secures connections between endpoints in Azure and provides performance benefits.

If required by your business needs, you can disable an Azure Private Link connection. If you disable Azure Private Links, Cloud Manager configures Cloud Volumes ONTAP to use a service endpoint, instead.
...
If required for your Azure configuration, you can disable new Cloud Volumes ONTAP systems from using an Azure Private Link connection. Any new systems will use service endpoints instead.
...
In most cases, there’s nothing that you need to do—​Cloud Manager manages Azure Private Links for you. But if you use Azure Private DNS, then you’ll need to edit a configuration file. You should also be aware of a requirement for the Connector location in Azure.
