...
Specify an NTP server using the https://docs.netapp.com/us-en/cloud-manager-automation/cm/api_ref_resources.html[BlueXP API^] or from the user interface when you link:task-create-volumes.html#create-a-volume[create a CIFS server].
