...
To enable tiering for a different tenant in a scenario where the Cloud Volumes ONTAP working environment is created by one tenant and the Connector is created by another, ensure the following:
