...
NOTE: AWS Local Zones are supported when using BlueXP in standard mode and restricted mode. At this time, AWS Local Zones are not supported with BlueXP private mode.
