...
.Steps
. Open the Advanced View to resize a volume through System Manager. Refer to link:task-administer-advanced-view.html#how-to-get-started[How to get started].
