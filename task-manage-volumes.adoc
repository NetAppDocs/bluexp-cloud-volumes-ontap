...
.. Select the aggregate, then click the *... (ellipse icon) > Increase Capacity*.
+
image:screenshot_aggr_increase_capacity_button.png[A screenshot of the Increase Capacity button under the Aggregates tab.]

.. Adjust the capacity as needed, and then click *Increase*.
