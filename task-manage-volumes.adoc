...
+
For details, see link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-volumes.html#move-volumes-to-another-aggregate-to-avoid-capacity-issues[Move volumes to another aggregate to avoid capacity issues].
...
+
For details, see link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-volumes.html#move-volumes-to-another-system-to-avoid-capacity-issues[Move volumes to another system to avoid capacity issues].
