...
.Steps
. Open Advanced View to resize your volume by using System Manager. See link:task-administer-advanced-view.html#how-to-get-started[Administer Cloud Volumes ONTAP using the Advanced View] to know how to get started.
