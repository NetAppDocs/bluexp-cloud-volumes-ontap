...
.. On the *Details and Credentials* page, click *Edit Credentials* and click *Add Subscription* to subscribe to the pay-as-you-go offering in the Azure Marketplace.
+
