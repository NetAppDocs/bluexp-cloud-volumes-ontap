...
NOTE: This endpoint does not apply if you are using BlueXP in private mode.
...
| 
NOTE: The exact endpoint depends on the AWS region that you are using. Refer to https://docs.aws.amazon.com/general/latest/gr/rande.html[AWS documentation for details]. 
