...
| 
Authentication
Available in standard and restricted modes.
...
| 
Key Vault.
Available in standard, restricted, and private modes.
...
// |Retrieval of the BlueXP tenancy data.  
...
a| Available in standard, restricted, and private modes.
...
// | Communications to AWS services.
