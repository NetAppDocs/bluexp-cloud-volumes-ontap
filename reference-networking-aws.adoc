...
| iSCSI data | eth0 | node 1 and node 2 | Client access over the iSCSI protocol. Also, used by system for other important networking workflows. These LIFs are required and should not be deleted.
