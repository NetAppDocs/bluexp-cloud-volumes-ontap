...
TIP: Looking for information about the Connector? https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-ports-aws.html[View security group rules for the Connector^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-aws.html[View networking requirements for the Connector^]
