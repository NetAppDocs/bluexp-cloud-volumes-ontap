...
TIP: This feature has been deprecated and will be removed in a future release. It has been replaced with the ability to add managed-Kubernetes clusters to the Canvas as a working environment for advanced data management. link:concept-kubernetes.html[Learn more].
