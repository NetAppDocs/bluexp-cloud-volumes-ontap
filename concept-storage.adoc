...
* ##_Premium SSD V2 Managed Disks_ provide higher performance with lower latency at a lower cost compared to Premium SSD Shared Managed Disks. For both single node and HA pairs, Premium SSD V2 Managed Disks provide higher performance with lower latency at a lower cost. The maximum disk size is 32 TiB.##
