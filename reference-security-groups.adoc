...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/reference-security-groups.html#rules-for-the-connector[View security group rules for the Connector^]