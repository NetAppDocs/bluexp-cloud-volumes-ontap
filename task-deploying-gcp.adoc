...
** You should have a https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-gcp.html[Connector that is associated with your workspace].
...
. If you're prompted, https://docs.netapp.com/us-en/cloud-manager-connector/task-creating-connectors-gcp.html[create a Connector].
