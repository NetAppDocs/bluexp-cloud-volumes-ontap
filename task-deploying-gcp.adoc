...
NOTE: This is the service account that you set up for BlueXP, link:task-creating-connectors-gcp.html#set-up-a-service-account-for-the-connector[as described on this page].
