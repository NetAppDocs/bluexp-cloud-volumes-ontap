...
| Service Account Name | If you plan to use the link:concept-data-tiering.html[data tiering] or https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html[backup and recovery^] services, you need to enable the *Service Account* switch and then select the Service Account that has the predefined Storage Admin role.
