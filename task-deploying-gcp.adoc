...
** You should have a link:task-creating-connectors-gcp.html[Connector that is associated with your workspace].
...
. If you're prompted, link:task-creating-connectors-gcp.html[create a Connector].
...
| Service Account Name | If you plan to use link:concept-data-tiering.html[data tiering] or link:concept-backup-to-cloud.html[Cloud Backup] with Cloud Volumes ONTAP, then you need to enable *Service Account* and select a service account that has the predefined Storage Admin role. link:task-creating-gcp-service-account.html[Learn how to create a service account].
...
|===
+
The following video shows how to associate a pay-as-you-go Marketplace subscription to your GCP project. Alternatively, follow the steps to subscribe located in the link:task-adding-gcp-accounts.html#associating-a-marketplace-subscription-with-gcp-credentials[Associating a Marketplace subscription with GCP credentials] section.
+
...
* For help with adding a GCP account, see link:task-adding-gcp-accounts.html[Setting up and adding GCP accounts for data tiering with 9.6].
...
| Service Account Name | If you plan to use the link:concept-data-tiering.html[Tiering] or link:concept-backup-to-cloud.html[Cloud Backup] services, you need to enable the *Service Account* switch and then select the Service Account that has the predefined Storage Admin role.
...
NOTE: This is the service account that you set up for Cloud Manager, link:task-getting-started-gcp.html#service-account[as described in step 4b on this page].
