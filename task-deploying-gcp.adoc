...
* For help with adding a GCP account, see https://docs.netapp.com/us-en/cloud-manager-get-started/task-adding-gcp-accounts.html[Setting up and adding GCP accounts for data tiering with 9.6^].
