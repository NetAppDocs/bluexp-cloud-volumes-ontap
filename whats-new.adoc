...
//== 28 February 2025
//include::_whatsnew/2025-02-28.adoc[]

// tag::whats-new[]

== 4 March 2025
include::_whatsnew/2025-03-04-916.adoc[]
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9151-relnotes/[Learn about the new features included in this release of Cloud Volumes ONTAP^].
...
The minimum Cloud Volumes ONTAP version required for configuring Flash Cache on Azure is 9.13.1 GA. You can only use ONTAP 9.13.1 GA and later versions for deploying Flash Cache on Cloud Volumes ONTAP systems in Azure. 
...
link:https://docs.netapp.com/us-en/cloud-volumes-ontap-9150-relnotes/[Learn about the new features included in this release of Cloud Volumes ONTAP^].
...
https://docs.netapp.com/us-en/ontap/object-storage-management/index.html[ONTAP documentation: Learn how to configure and manage S3 object storage services^]
...
For information on how to configure and use NDMP, refer to the https://docs.netapp.com/us-en/ontap/ndmp/index.html[ONTAP documentation: NDMP configuration overview].
...
* *Edge Cache*: Licensing for https://bluexp.netapp.com/cloud-volumes-edge-cache[Cloud Volumes Edge Cache^]
...
https://bluexp.netapp.com/pricing[Learn about pricing for WORM storage^].
...
Data is automatically encrypted on Cloud Volumes ONTAP in Azure using https://learn.microsoft.com/en-us/azure/security/fundamentals/encryption-overview[Azure Storage Service Encryption^] with a Microsoft-managed key. But you can now use your own customer-managed encryption key instead by completing the following steps:
