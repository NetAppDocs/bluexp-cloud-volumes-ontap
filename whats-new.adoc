...
//tag::whats-new[]
== 8 December 2023
The following changes were introduced with the 3.9.36 release of the Connector.
...
You can now create and resize FlexVol volumes up to the maximum size of 300 TiB starting from Cloud Volumes ONTAP 9.12.1 P2 and 9.13.0 P2 in all cloud providers.
