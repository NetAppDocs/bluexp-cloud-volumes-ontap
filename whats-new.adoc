...
Edge Cache capacity-based licensing packages will no longer be available for future deployments. However, it's possible to convert an existing Edge Cache package to another one, based on a valid BYOL license or an associated marketplace subscription.
