...
If required by your security policies, you can configure your EC2 instances to use IMDSv2. For instructions, refer to link:https://docs.netapp.com/us-en/bluexp-setup-admin_march-2024-2/task-managing-connectors.html#require-the-use-of-imdsv2-on-amazon-ec2-instances[BlueXP setup and administration documentation for managing existing Connectors^]. 
