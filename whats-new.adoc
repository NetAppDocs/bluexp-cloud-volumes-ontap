...
Cloud Volumes ONTAP 9.13.0 now includes support for increasing and decreasing volume size. This release of the Connector enables you to increase or decrease an ONTAP FlexGroup volume or FlexVol volume when using the API. 
