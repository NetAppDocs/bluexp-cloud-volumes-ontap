...
Cloud Volumes ONTAP now includes support for increasing and decreasing the size of a Cloud Volumes ONTAP FlexGroup volume or FlexVol volume when using the API. 
