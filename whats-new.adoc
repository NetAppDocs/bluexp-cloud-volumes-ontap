...
//tag::whats-new[]
== Date?
The following change was introduced with the 3.9.32 release of the Connector. 

=== Version support for AWS Secret regions
Cloud Volumes ONTAP software version 9.12.1 is now available in AWS Secret Cloud and Top Secret Cloud regions. 

link:https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-getting-started-aws-c2s.html[Get started in AWS Secret regions]
