...
The enhancements described on this page are specific to Cloud Manager features that enable management of Cloud Volumes ONTAP. https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/index.html[View the Cloud Volumes ONTAP Release Notes^] to learn what's new with the Cloud Volumes ONTAP software itself.
...
Now that the introductory special rate has expired, you will now be charged for using WORM storage. Charging is hourly, according to the total provisioned capacity of volumes. This applies to new and existing Cloud Volumes ONTAP systems.

https://cloud.netapp.com/pricing[Learn about pricing for WORM storage^].

== 27 February 2022 (Connector 3.9.16)
...
== 30 January 2022 (Connector 3.9.15)
...
link:concept-netapp-accounts.html[Learn more about NetApp accounts].

== 2 January 2022 (Connector 3.9.14)
...
== 28 November 2021 (Connector 3.9.13)
...
== 4 October 2021 (Connector 3.9.11)
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes[View supported configurations for Cloud Volumes ONTAP in AWS^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes[View supported configurations for Cloud Volumes ONTAP in GCP^].
