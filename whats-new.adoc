...
=== Free trials for marketplace subscriptions decommissioned

The 30-day free trial for pay-as-you-go subscriptions in cloud provider's marketplace will no longer be available for Cloud Volumes ONTAP. The charging for any type of marketplace subscription (PAYGO or annual contract) shall be activated from the first use without a free trial period. 
