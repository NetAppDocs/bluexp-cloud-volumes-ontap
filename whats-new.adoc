...
The minimum ONTAP version required for configuring Flash Cache on Azure is 9.13.1 GA. Only ONTAP 9.13.1 GA and later can be used for deploying Flash cache on Cloud Volumes ONTAP.
