...
The following permissions are now required to better optimize how Cloud Manager creates an AWS spread placement group for an HA pair that's deployed in a single Availability Zone (AZ):
...
The following changes were introduced with the 3.9.17 release of the Connector.
