...
//The whats-new tag should be enclosed around the three most recent releases. Be sure to use absolute URLs for links and images. This is required so that the what's new content can be reused in the cloud-manager-relnotes doc site. To begin the tag, use //tag::whats-new[]. To end the tag, use //end::whats-new[].

//tag::whats-new[]
== 3 April 2023
The following changes were introduced with the 3.9.28 release of the Connector. This release includes bug fixes.  
