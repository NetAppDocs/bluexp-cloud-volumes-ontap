...
Beginning with this release, when you try to upgrade Cloud Volumes ONTAP using the BlueXP notification, you will receive guidance on the default, latest, and compatible version to use. Additionally, you now have the option to select the latest patch or major version compatible with your Cloud Volumes ONTAP instance or manually enter a version for upgrade.
