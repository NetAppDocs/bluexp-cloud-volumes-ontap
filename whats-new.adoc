...
//tag::whats-new[]
== 2 July 2023
The following change was introduced with the 3.9.31 release of the Connector.
...
Autonomous Ransomware Protection (ARP) is now supported on Cloud Volumes ONTAP. 
