...
The L16s_v3, L32s_v3, L48s_v3, and L64s_v3 instance types are now supported with Cloud Volumes ONTAP in Azure for single node systems and for HA pairs with shared managed disks in a single availability zone and in multiple availability zones, starting with the 9.13.1 release. These instance types support Flash Cache. 
