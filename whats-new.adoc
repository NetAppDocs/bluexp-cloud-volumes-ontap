...
link:task-create-volumes.html[Learn how to create volumes on a specific aggregate].
...
link:task-manage-node-licenses.html#exchange-unassigned-node-based-licenses[Learn how to exchange unassigned node-based licenses].
//end::whats-new[]
