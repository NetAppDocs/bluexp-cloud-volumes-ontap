...
=== Amazon Web Services Local Zones support in private mode

Support for AWS Local Zones is now available in private mode for Cloud Volumes ONTAP HA deployments. Along with standard mode, Local Zones are supported when using BlueXP in private mode. 
