...
== 7 Aug 2024
Edge Cache capacity-based licensing packages will no longer be available for future deployments. However, it will be possible to convert an existing Edge Cache package to another one, based on an existing and valid BYOL license, or an associated marketplace subscription.
