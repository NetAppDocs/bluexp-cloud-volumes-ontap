...
summary: Learn what's new with Cloud Volumes ONTAP management in BlueXP (Cloud Manager).
---
...
[.lead]
Learn what's new with Cloud Volumes ONTAP management in BlueXP (Cloud Manager).
