...
The K8s tab was deprecated in a previous and has now been removed. It has been replaced with the ability to add managed-Kubernetes clusters to the Canvas as a working environment for advanced data management.
