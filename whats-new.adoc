...
=== Support for modifying volume size
Cloud Volumes ONTAP now includes support for increasing and decreasing volume size. This release of the Connector enables you to increase or decrease a Cloud Volumes ONTAP FlexGroup volume or FlexVol volume when using the API. 

=== Support for comments during volume creation
Cloud Volumes ONTAP now includes support for adding comments during volume creation. This release of the Connector enables you to make comments when creating a Cloud Volumes ONTAP FlexGroup volume or FlexVol volume when using the API.
