...
Refer to the https://docs.netapp.com/us-en/cloud-manager-automation/index.html[BlueXP automation docs^] for more details about using the "GcpEncryption" parameter.
