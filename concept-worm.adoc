...
+
For more information, refer to https://docs.netapp.com/us-en/ontap/snaplock/initialize-complianceclock-task.html[ONTAP documentation: Initialize the Compliance Clock^].
. Click *Set*.
