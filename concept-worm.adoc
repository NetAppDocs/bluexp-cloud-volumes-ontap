...
+
To enable WORM on a Cloud Volumes ONTAP working environment see link:../concept-worm.html#worm-on-a-cloud-volumes-ontap-working-environment[Enabling WORM on a Cloud Volumes ONTAP working environment]
