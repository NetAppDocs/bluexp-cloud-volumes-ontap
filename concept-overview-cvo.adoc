...
+
Cloud Volumes ONTAP also integrates with BlueXP backup and recovery (Cloud Backup) to deliver backup and restore capabilities for protection, and long-term archive of your cloud data.
+
