...
. On the *Cloud Volumes ONTAP* page, select *Change Charging Method*.
+
...
. On the *Data service licenses* tab, click the action menu next to the license and select *Remove License*.
