...
To learn about what happens to your Cloud Volumes ONTAP data on expiry or removal of your license, see https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/CVO_Licensing_issues[this knowledge base (KB)article].
