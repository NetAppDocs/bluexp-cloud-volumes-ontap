...
. With *Capacity Based Licenses* selected, view the packages summary, which shows you consumed capacity, total precommitted capacity, and total PAYGO capacity.
+
...
+
* _Precommitted capacity_ is the total licensed capacity (BYOL or Marketplace Contract) that you purchased from NetApp.
** _BYOL_ shows you the total licensed capacity that you purchased from NetApp for this package type.
** _Marketplace Contracts_ shows the total licensed capacity that you purchased with a marketplace contract for this package type.
+
