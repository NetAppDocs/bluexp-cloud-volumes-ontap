...
If a capacity-based license expired and is no longer in use, then you can remove it at any time. To learn about what happens to your Cloud Volumes ONTAP data, see the knowledge base article https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/CVO_Licensing_issues[KB:CVO Licensing issues].
