...
The following reports are available for download. Capacity values shown are in GiB. 
...
+
** Working environment ID (appears as the UUID)
** Cloud
** NetApp account ID
...
+
NOTE: FlexClone volumes are not included in the report because these types of volumes do not change. 
