...
BlueXP also modifies the `default-data-files` policies of data LIFs on the data storage VMs by removing the following services from NAS data LIFs and adding them to iSCSI data LIFs:
