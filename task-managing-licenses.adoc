...
* If you want to enter the serial number, you first need to link:task-adding-nss-accounts.html[add your NetApp Support Site account to Cloud Manager]. This is the NetApp Support Site account that's authorized to access the serial number.
