...
[NOTE]
##NetApp has restricted purchase, extension, and renewal of BYOL licensing. For information, refer to https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#end-of-availability-of-byol-licensing-for-cloud-volumes-ontap[End of availability of BYOL licensing for Cloud Volumes ONTAP^].##
...
* If you purchase a license from NetApp (BYOL), you also need to subscribe to the PAYGO offering from your cloud provider's marketplace. ##NetApp has started a phased decommissioning of BYOL licensing. When your BYOL licenses expire, you must replace your BYOL licenses with cloud marketplace subscriptions.##
+
...
* Only single node systems with BYOL are supported in China regions. ##China region deployments are exempt from the BYOL decommissioning.##
