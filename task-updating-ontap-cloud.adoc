...
Refer to the https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-updating-ontap-cloud.html#supported-upgrade-paths[Supported upgrade paths list^] for the appropriate upgrade path based on your current Cloud Volumes ONTAP version.   
+
