...
. Select an aggregate title, click the ellipse button, and then select *View Aggregate details*.
+
...
. Click *Upgrade*.
+
image:screenshot_upgrade_CVO.png[A screenshot that shows the Upgrade Cloud Volumes ONTAP page.]
