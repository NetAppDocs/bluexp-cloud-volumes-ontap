...
. Click *Upgrade*.
+
NOTE: The Upgrade Cloud Volumes ONTAP page selects the latest available Cloud Volumes ONTAP version for upgrade by default. If available, older versions of Cloud Volumes ONTAP can instead be selected for your upgrade by clicking *Older versions* under the Upgrade Cloud Volumes ONTAP page.  
