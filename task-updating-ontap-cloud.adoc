...
+
##If you want to upgrade to another version, click *Select other versions*. You see the latest two Cloud Volumes ONTAP versions listed that are also compatible with the installed version on your system. For example, if the installed version on your system is 9.12.1P7, and the latest compatible versions available are 9.14.1, 9.13.1P2, and 9.13.1P1, then you see 9.14.1 as the default version for upgrade, and 9.13.1P2 and 9.13.1P1 as the other versions. Select a version and click *Apply*.##

. ##Optionally, you can click *All versions* to enter another compatible version that you want to upgrade to (say, the next patch of the installed version). Click *Save*, and then *Apply*.##
