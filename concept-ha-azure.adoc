...
For available regions, refer to link:https://review.docs.netapp.com/us-en/cloud-volumes-ontap-relnotes_9121-rc-2022-hotfixes/reference-new.html#azure-ha-in-a-single-availability-zone-with-shared-managed-disks[Microsoft Azure's documentation]. 
