...
##Cloud Volumes ONTAP 9.15.1 and later support creation and management of heterogeneous, auto-scaling virtual machines (VMs) in single availability zones. The Flexible orchestration mode of Azure Virtual Machine Scale Sets helps in the zonal deployment of VMs into distinct fault domains to ensure high availability. To learn more, refer to the https://learn.microsoft.com/en-us/azure/virtual-machine-scale-sets/[Virtual Machine Scale Sets documentation^].##
...
VMs in single availability zones::
##Cloud Volumes ONTAP 9.15.1 and later support creation and management of heterogeneous, auto-scaling virtual machines (VMs) in single availability zones. The Flexible orchestration mode of Azure Virtual Machine Scale Sets helps in the deployment of VMs into distinct fault domains to ensure high availability. To learn more, refer to the https://learn.microsoft.com/en-us/azure/virtual-machine-scale-sets/[Virtual Machine Scale Sets documentation^].##
