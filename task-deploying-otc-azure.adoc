...
** You should have a https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html[Connector that is associated with your workspace^].
...
. If you're prompted, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html[create a Connector^].
...
* https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html[Learn more about BlueXP backup and recovery (Cloud Backup)^]
+
...
TIP: If the Azure account that you're using has the https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-azure.html[required permissions^], BlueXP removes Cloud Volumes ONTAP resources from a resource group, in case of deployment failure or deletion.
...
* The disk size is for all disks in the initial aggregate and for any additional aggregates that BlueXP creates when you use the simple provisioning option. You can create aggregates that use a different disk size by using the advanced allocation option.
+
For help choosing a disk size, see link:task-planning-your-config-azure.html#sizing-your-system-in-azure[Sizing your system in Azure].
* You can choose a specific volume tiering policy when you create or edit a volume.
* If you disable data tiering, you can enable it on subsequent aggregates.
+
link:concept-data-tiering.html[Learn more about data tiering].
