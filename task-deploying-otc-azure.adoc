...
. If you're prompted, link:task-creating-connectors-azure.html[create a Connector].
...
+
* link:concept-cloud-compliance.html[Learn more about Cloud Data Sense].
* link:concept-backup-to-cloud.html[Learn more about Cloud Backup].
* link:concept-monitoring.html[Learn more about the Monitoring service].
