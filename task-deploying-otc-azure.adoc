...
Note the following:
+
* ##If the public access to your storage account is disabled within the VNet, you cannot enable data tiering in your Cloud Volumes ONTAP system. For information, refer to link:/reference-networking-azure.html#only-one-ha-pair-in-an-azure-resource-group[Security group rules].##
