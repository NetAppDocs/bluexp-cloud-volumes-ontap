...
** You should have a link:task-creating-connectors-azure.html[Connector that is associated with your workspace].

** link:concept-connectors.html[You should be prepared to leave the Connector running at all times].
