...
[NOTE]
BYOL A node-based license is the previous generation BYOL for Cloud Volumes ONTAP. A node-based license is available for license renewals, only in specific cases.
