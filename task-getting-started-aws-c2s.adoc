...
Before you can start using BlueXP to deploy Cloud Volumes ONTAP in AWS, you must create and install a _Connector_. The Connector enables BlueXP to manage resources and processes within your public cloud environment (this includes Cloud Volumes ONTAP). After Connector creation and installation, you must launch the Connector instance from the AWS Marketplace and then log in and set up BlueXP. 
