...
. <<Prepare your AWS environment,Preparing your AWS environment>>
+
...
== Step 2: Install the Connector and set up BlueXP

Before you can launch Cloud Volumes ONTAP systems in AWS, you must first launch the Connector instance from the AWS Marketplace and then log in, set up BlueXP, and install a certificate for private mode.
...
env
----
.. To list all installed certificates in truststore, run the following command: 
+ 
[source,CLI]
----
keytool -list -v -keystore occm.truststore
----
Use the password collected in the previous step. 
...
env
----
.. To add the certificate to the truststore, run the following command: 
+ 
[source,CLI]
----
...
== Step 3: Launch Cloud Volumes ONTAP from BlueXP
