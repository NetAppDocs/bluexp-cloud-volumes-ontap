...
=== Supported versions in AWS Secret Cloud and Top Secret Cloud
...
== Step 2: Subscribe to Cloud Volumes ONTAP
...
== Step 5: Install the Connector and set up BlueXP
Before you can start using BlueXP to deploy Cloud Volumes ONTAP in AWS, you must create a _Connector_. The Connector enables BlueXP to manage resources and processes within your public cloud environment (this includes Cloud Volumes ONTAP). After you install the Connector, you must launch the Connector instance from the AWS Marketplace and then log in and set up BlueXP. 
...
== Step 6: Install a private mode certificate
This section provides the steps for installing a private mode certificate.
