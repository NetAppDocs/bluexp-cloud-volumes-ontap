...
[.lead]
Some advanced capabilities of storage management in Cloud Volumes ONTAP are available through ONTAP System Manager, a management interface provided with ONTAP systems. You can access the System Manager interface directly within BlueXP.


== Features

You can perform various storage management functions using ONTAP System Manager in BlueXP. The following list includes some of the features available through System Manager, though this list is not exhaustive:
...
* S3 object storage management: S3 object management in Cloud Volumes ONTAP is available only in System Manager, and not in BlueXP. You can create and manage S3 buckets, object stores, and object access policies.
