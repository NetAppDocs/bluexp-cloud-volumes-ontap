...
[NOTE]
This setting is not controlled by BlueXP. This is a global setting that applies to all ONTAP users in your organization or account, irrespective of Cloud Volumes ONTAP working environments or BlueXP projects.
