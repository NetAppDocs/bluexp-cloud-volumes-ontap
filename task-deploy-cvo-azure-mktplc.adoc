...
[.lead]
Beginning with Cloud Volumes ONTAP 9.16.1, you can use Azure marketplace direct deployment to quickly and easily deploy Cloud Volumes ONTAP from the Azure marketplace, and explore its core features and capabilities within your environment.
