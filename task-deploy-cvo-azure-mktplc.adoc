...
[.lead]
Beginning with Cloud Volumes ONTAP 9.16.1, you can use Azure marketplace direct deployment to quickly and easily deploy Cloud Volumes ONTAP and explore its core features within your environment.
...
* One data SVM deployed, with  NFS, CIFS, iSCSI, and NVMe/TCP data-services. No provision for adding more SVMs.
...
Select the notification icon to view the progress of your deployment. After Cloud Volumes ONTAP is deployed, you can view the SVM listed for operations.

Once accessible, use ONTAP System Manager or the ONTAP CLI to log in to the SVM with the admin credentials that you set. Thereafter, you can create volumes, LUNs, or shares and start utilizing the storage capabilities of Cloud Volumes ONTAP.
