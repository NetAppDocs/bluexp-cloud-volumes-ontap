...
* Enables capacity management features in both link:concept-storage-management.html#capacity-management[automatic and manual modes] for the discovered systems.
