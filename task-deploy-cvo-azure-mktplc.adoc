...
[NOTE]
The BlueXP Connector can discover the systems only when the deployment is complete on the Azure marketplace.
...
After BlueXP completes the discovery and adds the systems, you can perform various management tasks, such as, expanding the aggregate, adding volumes, provisioning additional storage VMs and adding data LIFs to them, and changing the instance types.
