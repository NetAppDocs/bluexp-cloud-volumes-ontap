...
. https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html[Set up one-time data replication^] between the systems for each volume that you must replicate.
