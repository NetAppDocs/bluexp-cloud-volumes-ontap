...
| 
Azure Related endpoints: Public Regions 
...
| Used by Cloud Volumes ONTAP to talk to the Azure cloud provider. 

| Azure provider call

| Management for Azure provider functionalities in OCCM will be unavailable. 

| 
Azure Related endpoints: China Region
...
| 
Azure Related endpoints: Germany Region
...
| 
Azure Related endpoints: Government Regions
...
| 
Azure Related endpoints: Government DoD regions
