...
* If you haven't registered an NSS account in Cloud Manager, link:task-adding-nss-accounts.html[register an NSS account now] and then the Active IQ Digital Advisor UI appears.
