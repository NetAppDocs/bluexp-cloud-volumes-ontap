...
Resources managed by other services like backups for BlueXP backup and recovery (Cloud Backup) and instances for BlueXP classification (Cloud Data Sense) and Monitoring are not deleted when you delete a working environment. You'll need to manually delete them yourself. If you don't, then you'll continue to receive charges for these resources.
