...
.. Under the Delete Working Environment window, type the name of the working environment and then click *Delete*. It can take up to five minutes to delete the working environment.
