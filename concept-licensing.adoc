...
=== Functioning of capacity-based licenses
The functioning of Cloud Volumes ONTAP PAYGO and BYOL licenses depends on the availability of the BlueXP connector. For more information, refer to https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html#impact-on-cloud-volumes-ontap[Learn about Connectors].
