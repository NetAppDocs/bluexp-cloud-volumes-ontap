...
##With the decommissioning of node-based licensing for Cloud Volumes ONTAP systems, you have to convert your existing systems with node-based licenses to capacity based. For information about how you can perform this conversion, refer to link:concept-license-management.html[License management for node-based systems].##
