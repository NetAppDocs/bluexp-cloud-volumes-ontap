...
==== Licenses purchased from NetApp
...
==== Marketplace subscriptions (hourly)
...
TIP: You can manage marketplace subscriptions from the Settings > Credentials page.
+
ifdef::aws[]
...
==== Marketplace subscriptions (annual contract)
