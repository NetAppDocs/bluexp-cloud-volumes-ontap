...
*	Available only in the Azure and Google Cloud Marketplaces as a pay-as-you-go offering or as an annual contract
* Supported with selected VM types: 
** Azure: E4s_v3, E4ds_v4, DS4_v2, DS13_v2, E8s_v3, E8ds_v4, 
