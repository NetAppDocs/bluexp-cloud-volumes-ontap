...
[IMPORTANT]
Node-based licensing will be deprecated shortly, to be replaced by capacity-based licenses. For information, refer to https://mysupport.netapp.com/info/communications/CPC-00589.html[Customer communique: CPC-00589^].
