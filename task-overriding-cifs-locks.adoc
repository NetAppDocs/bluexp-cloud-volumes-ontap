...
You need to create a Connector before you can change Cloud Manager settings. https://docs.netapp.com/us-en/cloud-manager-connector/concept-connectors.html#how-to-create-a-connector[Learn how^].
