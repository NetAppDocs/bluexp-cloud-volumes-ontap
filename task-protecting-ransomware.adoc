...
The ARP feature is available for use with BYOL and marketplace subscriptions for your licenses at no additional cost. Contact your NetApp sales representative to add ARP to your current license.
