...
##For HA-mode zonal deployments in single availability zones, you should subscribe to the `Microsoft.Compute/VMOrchestratorZonalMultiFD` feature. For more information, refer to link:task-saz-feature.html[Enable HA deployment in single availability zones].##
