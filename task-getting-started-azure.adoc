...
##Cloud Volumes ONTAP 9.15.1 and later support the deployment of VM instances in locally-redundant storage (LRS) single availability zones. For this, you should subscribe to the `Microsoft.Compute/VMOrchestratorZonalMultiFD` feature. For more information, refer to link:task-saz-feature.html[Enable VMOrchestratorZonalMultiFD for single availability zones].##
