...
##Cloud Volumes ONTAP 9.15.1 and later supports the deployment of VM instances in locally-redundant storage (LRS) single availability zone. For this, you should subscribe to the `Microsoft.Compute/VMOrchestratorZonalMultiFD` feature. For more information, refer to link:task-saz-feature.html[Enable VMOrchestratorZonalMultiFD for single availability zones].##
