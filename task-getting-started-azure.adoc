...
If you don't have a link:concept-connectors.html[Connector] yet, an Account Admin needs to create one. link:task-creating-connectors-azure.html[Learn how to create a Connector in Azure].
...
* link:task-creating-connectors-azure.html[Creating a Connector from Cloud Manager]
* link:task-launching-azure-mktp.html[Creating a Connector from the Azure Marketplace]
